  ...
  <body>
    	...
    	<div class="container">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="media d-block text-center block-6 services">
              ...
              <div class="media-body">
                <h3 class="heading">Teint &amp; Soins de beauté</h3>
                <p>Nous faisons des soins de beauté pour que vous ayez un teint lumineux et en éclatant pour tout mariage,céremonie...</p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 ftco-animate">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="media d-block text-center block-6 services">
              ...
              <div class="media-body">
                <h3 class="heading">Coiffure</h3>
                <p>Des coiffure simple, élegante.</p>
              </div>
            </div>    
          </div>
        </div>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
		...
		<section class="ftco-section ftco-discount img" style="background-image: url(frontend2/images/bg_2.jpg);">
			<div class="overlay"></div>
			<div class="container">
				<div class="row justify-content-end">
					<div class="col-md-5 discount ftco-animate">
						<h3>Économisez jusqu'à 50%</h3>
						<h2 class="mb-4">Réduction pour les étudiantes</h2>
						<p class="mb-4">En ce moment nous sommes en mode cadeaux avec etudiantes, prend rendez-vous,viens avec ta carte d'étudiantes et profite!!!.</p>
    ...
    <section class="ftco-partner bg-light">
		...
		<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(frontend2/images/bg_4.jpg);">
			<div class="overlay"></div>
      <div class="container">
		          ...
		          <div class="col-md-6 col-lg-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		              	...
		              	<span>MAKEUP </span>
		                <strong class="number" data-number="185">150</strong>
		              </div>
		            </div>
		          </div>
		          <div class="col-md-6 col-lg-3 d-flex justify-content-center counter-wrap ftco-animate">
